  ...
  return (
    <div className="bg-light rounded mx-auto p-3 mt-5 w-50">
      <form className="formCustom mx-auto shadow rounded px-3 pt-3 pb-3 mb-3">
        <h1 className="contactFont mb-4" style={{ fontWeight: 'bold' }}> Contact / Feedback Form</h1>
        <div className="mb-3">
        ...
        <div className="d-flex justify-content-center">
          <button className="btn btn-primary btn-lg me-1 w-50" onClick={handleSubmitForm}>
            Send
          </button>

          <button className="btn bg-secondary btn-lg ms-2 text-white w-50" onClick={handleResetForm}>
            Reset
          </button>
        </div>
      </form>
